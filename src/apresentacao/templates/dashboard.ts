...
<body class="bg-gray-50 font-sans text-gray-900">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 overflow-y-auto transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-30 pt-16 md:pt-0">
        <div class="p-6 border-b border-gray-100 hidden md:flex items-center space-x-3">
            <div class="h-10 w-10 bg-brand-yellow rounded-full flex items-center justify-center shadow-sm">
                <i class="fas fa-bolt text-white text-lg"></i>
            </div>
            <span class="font-extrabold text-2xl text-gray-900 tracking-tight">Spedito</span>
        </div>

        <nav class="p-4 space-y-1">
            <a href="#" onclick="showSection('overview', this)" class="menu-item active flex items-center px-4 py-3 rounded-lg transition-colors duration-200">
                <i class="fas fa-chart-pie w-6 text-center mr-3"></i>
                <span>Visão Geral</span>
            </a>
            <a href="#" onclick="showSection('xmls', this)" class="menu-item flex items-center px-4 py-3 rounded-lg text-gray-600 transition-colors duration-200">
                <i class="fas fa-file-code w-6 text-center mr-3"></i>
                <span>XMLs & SPED</span>
            </a>
            <a href="#" onclick="showSection('correlation', this)" class="menu-item flex items-center px-4 py-3 rounded-lg text-gray-600 transition-colors duration-200">
                <i class="fas fa-link w-6 text-center mr-3"></i>
                <span>Correlação</span>
            </a>
            <a href="#" onclick="showSection('tax-map', this)" class="menu-item flex items-center px-4 py-3 rounded-lg text-gray-600 transition-colors duration-200">
                <i class="fas fa-balance-scale w-6 text-center mr-3"></i>
                <span>Mapa Tributário</span>
            </a>
            <a href="#" onclick="showSection('settings', this)" class="menu-item flex items-center px-4 py-3 rounded-lg text-gray-600 transition-colors duration-200">
        ...
        <div class="absolute bottom-0 w-full p-4 border-t border-gray-100 bg-white">
            ...
            <button onclick="logout()" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200">
    ...
    <!-- Main Content -->
    <main class="flex-1 ml-0 md:ml-64 p-4 md:p-8 pt-20 md:pt-8 min-h-screen transition-all duration-300">
